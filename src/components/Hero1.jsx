...
// Moved SVG icons outside the component to prevent recreation on each render
...
const AIAAHero = () => {
  ...
  // Parallax effects with optimized ranges
  ...
  // Memoized particles to prevent recreation on every render
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(6,182,212,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(6,182,212,0.02)_1px,transparent_1px)] bg-[size:60px_60px] sm:bg-[size:80px_80px]" />
