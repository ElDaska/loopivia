        ...
        <div className="space-y-4">
          <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h4 className="font-semibold text-green-300 mb-2">Disponibilité du service</h4>
                <p className="text-gray-300 leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-800/30 rounded-lg p-4 border border-green-600/20">
                <div className="flex items-center gap-2 mb-2">
                  <Clock className="w-4 h-4 text-green-400" />
                  <span className="font-medium text-green-300">Disponibilité</span>
                </div>
              ...
              <div className="bg-green-800/30 rounded-lg p-4 border border-green-600/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-green-300">Maintenance</span>
                </div>
                <p className="text-sm text-gray-300">
            ...
            <div className="mt-4 p-3 bg-amber-900/20 rounded-lg border border-amber-600/20">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-amber-300">Réserve de modification</span>
              </div>
              <p className="text-sm text-gray-300">
      ...
      content: (
        <div className="bg-purple-900/20 border border-purple-700/30 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-purple-300 mb-2">Propriété intellectuelle</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="bg-purple-800/30 rounded-lg p-4 border border-purple-600/20">
                <div className="flex items-center gap-2 mb-3">
                  <Lock className="w-4 h-4 text-purple-400" />
                  <span className="font-medium text-purple-300">Restrictions d'usage</span>
                </div>
              ...
              <p className="text-sm text-purple-200 bg-purple-800/20 p-3 rounded-lg">
      ...
      content: (
        <div className="bg-orange-900/20 border border-orange-700/30 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-orange-300 mb-2">Limitation de responsabilité</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-orange-800/30 rounded-lg p-4 border border-orange-600/20">
                  <h5 className="font-medium text-orange-300 mb-2">Exclusions de responsabilité</h5>
                  <div className="space-y-2 text-sm text-gray-300">
                    <div className="flex items-center gap-2">
                ...
                <div className="bg-orange-800/30 rounded-lg p-4 border border-orange-600/20">
                  <h5 className="font-medium text-orange-300 mb-2">Engagements</h5>
                  <div className="space-y-2 text-sm text-gray-300">
                    <div className="flex items-center gap-2">
      ...
      content: (
        <div className="bg-cyan-900/20 border border-cyan-700/30 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-cyan-300 mb-2">Protection des données</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="bg-cyan-800/30 rounded-lg p-4 border border-cyan-600/20">
                <div className="flex items-center gap-3 mb-3">
                  <Lock className="w-5 h-5 text-cyan-400" />
                  <span className="font-medium text-cyan-300">Conformité RGPD</span>
                </div>
      ...
      content: (
        <div className="bg-indigo-900/20 border border-indigo-700/30 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-indigo-300 mb-2">Évolution des conditions</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="bg-indigo-800/30 rounded-lg p-4 border border-indigo-600/20">
                <h5 className="font-medium text-indigo-300 mb-2">Modalités de modification</h5>
              ...
              <p className="text-sm text-indigo-200 bg-indigo-800/20 p-3 rounded-lg">
      ...
      content: (
        <div className="bg-emerald-900/20 border border-emerald-700/30 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-emerald-300 mb-2">Support et questions</h4>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="bg-emerald-800/30 rounded-lg p-5 border border-emerald-600/20">
                <div className="flex items-center justify-between mb-3">
                  <h5 className="font-medium text-emerald-300">Email de support</h5>
              ...
              <div className="text-sm text-emerald-200 bg-emerald-800/20 p-3 rounded-lg">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm text-gray-400">
              <span>Accueil</span>
              <span>/</span>
              <span className="text-blue-400">Conditions Générales d'Utilisation</span>
            </div>
            <a 
              href="/" 
